...
const ModalCreateVisitor = ({ close }) => {
    ...
    const onSubmit = (e) => {
        ...
        if (phone.length != 10) {
            ...
            axios.post(BASE_URL + "/api/v1/visitors/create", visitor, { headers: headers })
                .then(res => {
                    Swal.fire({
                        title: "Thành công",
                        text: 'Thêm mới khách tham quan thành công!',
                        icon: "success",
                    }).then(() => {
                        close()
                        // location.reload();
                ...
                .catch(e => {
                    ...
                    if (e.response.status === 400) {
                        ...
                        errMes = 'Không thêm mới được khách tham quan'
                    } Swal.fire({
                        title: "Thất bại",
                        text: errMes,
                        icon: "error",
                        ...
                        <GridItem xs={12} sm={12} md={12}>
                            <Card profile>
                                <CardHeader color="primary">
                                    <h4 >Thêm mới khách tham quan</h4>
                                </CardHeader>
                                <CardBody>
                                    <GridContainer>
